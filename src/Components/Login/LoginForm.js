    ...
    <div className="d-flex justify-content-center align-items-center form-container">
      <form onSubmit={submitHandler} className="rounded p-4 p-sm-3 form">
        <div className="form-inner">
          ...
          {/* we have log in button for a regular and google sign in button if you have a google account
          , when the user successfully logs in they should be able 
          to navigate to dashboard using either buttons, so I dont know if we would need a router for both butttons*/}
